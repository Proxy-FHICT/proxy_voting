...
<ul class="mdl-list">
  ...
  <li class="mdl-list__item mdl-list__item--two-line">
    ...
    <span class="mdl-list__item-secondary-action">
      <label class="demo-list-radio mdl-radio mdl-js-radio mdl-js-ripple-effect" for="list-c-option-{{$teacher->id}}">
        <input type="radio" id="list-c-option-{{$teacher->id}}" class="mdl-radio__button" name="teachers" value="{{$teacher->id}}"/>
      </label>
    </span>
  </li>
  @endforeach
